...
namespace Dotnet.Onion.Template.API.DTO.Contrato
{
    public class Exp_ContratoDTO
    {
        ...
        public List<Exp_Agente_DTO> agentes { get; set; }
        #endregion
        ...
        public List<Exp_OIC_DTO> oics { get; set; }
        ...
        public List<CertificadosDTO> certificados { get; set; }
        #endregion
        ...
        public List<ContainersDTO> containers { get; set; }
